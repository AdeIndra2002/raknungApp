<aside class="z-20 hidden mt-1 md-2 mr-3 w-56 overflow-y-auto bg-gray-300 dark:bg-gray-800 md:block flex-shrink-0 shadow-xl rounded-3xl">
    <div class="py-4">
        <a class="flex items-center ml-6 text-lg font-bold  text-gray-700 hover:text-gray-500 dark:text-gray-400 dark:hover:text-gray-600" href="{{ route('dashboard') }}">
        ...
        <ul class="mt-6 ">
            ...
            <li class="relative px-6 py-3">
                <button class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150  text-gray-700 hover:text-gray-500 dark:text-gray-400 dark:hover:text-gray-600" @click="toggleMultiLevelMenu" aria-haspopup="true">
