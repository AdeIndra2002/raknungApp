                ...
                <table class="w-full whitespace-no-wrap bg-gray-100 dark:bg-gray-600">
                    ...
                    <tbody class="text-xs font-semibold tracking-wide text-center bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300">
                        ...
                        <tr class="border-b border-gray-200 dark:border-gray-600">
                            ...
                            <td class="px-4 py-3">{{ $data->kategori->kategori }}</td>
                            <td class="px-4 py-3">{{ $data->stok }}</td>
                            <td class="px-4 py-3">
                                <div class="flex justify-center space-x-1">
                                    {{-- <a href="{{ route('kategori.show', $pengajuan->id) }}" class="flex items-center px-2 py-2 text-sm font-medium leading-5 text-gray-800 bg-white-300 rounded-lg dark:text-gray-500 hover:dark:text-green-300 focus:outline-none focus:shadow-outline-gray" aria-label="Edit">
                                    ...
                                    <a href="{{ route('barang.edit', $data->id) }}" class="flex items-center px-2 py-2 text-sm font-medium leading-5 text-yellow-300 bg-white-300 rounded-lg dark:text-gray-500 hover:dark:text-yellow-300 focus:outline-none focus:shadow-outline-gray" aria-label="Edit">
