        ...
        <form action="{{ route('barang.update', $barang->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <div class="mt-4 relative">
                    <div class="relative">
                        <x-text-input placeholder=" " type="text" id="barang" name="barang" class="block w-full" value="{{ $barang->barang }}" required autofocus />
                ...
                <div class="mt-4 relative">
                    <x-text-input placeholder=" " type="number" id="stok" name="stok" class="block w-full" value="{{ $barang->stok }}" required autofocus />
                ...
                <div class="mt-4 card-footer">
                    <button type="submit" class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">Edit Data</button>
