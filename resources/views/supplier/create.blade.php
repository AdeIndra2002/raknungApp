        ...
        <form action="{{ route('supplier.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <div class="mt-4 relative">
                    <div class="relative">
                        <x-text-input placeholder=" " type="text" id="nama_supplier" name="nama_supplier" class="block w-full" value="{{ old('nama_supplier') }}" required autofocus />
                ...
                <div class="mt-4 relative">
                    <div class="relative">
                        <x-text-input placeholder=" " type="number" id="no_hp" name="no_hp" class="block w-full" value="{{ old('no_hp') }}" required autofocus />
                ...
                <div class="mt-4 relative">
                    <div class="relative">
                        <x-text-input placeholder=" " type="text" id="alamat" name="alamat" class="block w-full" value="{{ old('alamat') }}" required autofocus />
